...
{ // deque razkarva posledniq element, enque slaga nai-otpred
    ...
    struct Position// konstruktora koito 6te sudirja kordinatite
    {
        ...
        class Program
        {
            static void Main(string[] args)
            {
                ...
                { // nov list s elementite ot position
                    new Position(12,12),
                    new Position(14,20),
                    new Position(7,7),
                };
                    ...
                    //novata poziciq na zmiqta
	{
                    ...
                    // TOVA TUKA e za da kato izbqga ot ekrana da se izleze ot drugata strana
                    if (snakeNewHead.col<0)snakeNewHead.col = Console.WindowWidth-1; // ako zmiqta izleze ot 6iro4inata da dazpo4ne ot drugata strana
                   ...
                   // tova proverqva dali glavata na zmiqta ne e izlezla ot ekrana bukvalno
                    if (false) // row = red
                    {
                        ...
                        Console.WriteLine("Your points are: {0}",userPoints); // tova vru6ta broq elementi na zmiqta
                        Thread.Sleep(5000);
                    ...
                    randomNumberGenerator.Next(0, Console.WindowWidth)); // tuka 6te ni se generira slu4aino 4islo koeto 6te opredelq kade e qbalkata
                        ...
                        while(snakeElements.Contains(food));
                            ...
                            Random r = new Random();
                            Console.Beep(r.Next(100, 10000), r.Next(60, 500));  // tova e koda za random zvuk pri xapvane na qbalkata
                    }
                    ...
                    if (Environment.TickCount - lastFoodTime >= foodDisappearTime) // ako ot zapo4vaneto na programata maxnem posledniq spawn na qbulkata i e po-golqm ot 8 sec
                    {
                        negativePoints = negativePoints + 50;
                        Console.SetCursorPosition(food.col, food.row);
                        Console.WriteLine(" ");
                        do // do while tuka e da ne napravi qbalka v ramkite na zmiqta
                        {
                            food = new Position(randomNumberGenerator.Next(0, Console.WindowHeight), // slaga qbalkata na random mesto, no tozi put prosto vzima novi stoinosti za novata qbalka
                        randomNumberGenerator.Next(0, Console.WindowWidth)); // tuka 6te ni se generira slu4aino 4islo koeto 6te opredelq kade e qbalkata
                        }
